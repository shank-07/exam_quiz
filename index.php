...
<div class="" id="myModal" style="align-self: left; padding-top: 250px;">
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
        <h4 class="modal-title title1"><span style="color:darkblue;font-size:12px;font-weight: bold; justify-content: center;">Login to your Account</span></h4>
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input  autocomplete="off" id="username" name="username" placeholder="Username" class="form-control input-md" type="username">
...
<div class="bg" style="background-image: url(bg1.jpg); background-repeat: no-repeat; background-size: cover;">
<div class="row">

<div class="col-md-7"></div>
<div class="col-md-4 panel" style="visibility:hidden;"> 
...
<div class="form-group">
  ...
  <input  autocomplete="off" id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text" value="<?php
   if (isset($_GET["name"]))
  echo $_GET['name'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input autocomplete="off" id="rollno" name="rollno" placeholder="Enter your Roll no (Ex. BE/10XXX/YY)" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input autocomplete="off" id="username" name="username" placeholder="Choose a username" class="form-control input-md" type="username" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input autocomplete="off" id="phno" name="phno" placeholder="Enter your mobile number" class="form-control input-md" type="number" value="<?php
echo $_GET['phno'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12" style="text-align: center">
    <input autocomplete="off" type="submit" value=" Register Now " class="btn btn-primary" style="text-align:center" />
  </div>
</div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About E & B Academy</a></div>
</div>
...
<div class="form-group">
<input autocomplete="off" type="text" name="uname" maxlength="20"  placeholder="Username" class="form-control"/>
</div>
<div class="form-group">
<input autocomplete="off" type="password" name="password" maxlength="30" placeholder="Password" class="form-control"/>
</div>
