...
<div class="row">
<div class="col-lg-6">
<span class="logo">E & B Academy</span>
<h2 align="center" style="font-family:'typo'; color:#000066">Online Assesment</h2>   </div>
...
if (!(isset($_SESSION['username']))) {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:green"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:green">' . $username . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:green"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
</div>
</div></div>
<div class="bg" style="background-image: url(#); background-repeat: no-repeat; background-size: cover;"
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false" style="z-index:5; border-color:black;">
...
<div class="container">
<div class="row">
    <div class="overlap_notice_error" style="width: 100px; height: 100px; z-index: 10000 background-color:#f3f3f3;">
        ...
        <tr><td style="vertical-align:middle;;"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
          ...
          <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
            ...
            $c = 0;
            echo '</table></div><div class="panel" style="padding-top:1px;padding-left:5%;padding-right:5%;word-wrap:break-word"><h3 align="center" style="font-family:calibri">:: General Instructions ::</h3><br /><ul type="circle"><font style="font-size:14px;font-family:calibri">';
        ...
        var countdownTimer = setInterval(\'secondPassed()\', 1000);
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                        ...
                        $qid = $row['qid'];
                        echo '<b><div class="inside_que" style="width:990px;border-width:3px;border-style:solid;border-color:rgba(0,0,0,0.22);"><div style="font-size:20px;font-weight:bold;font-family:calibri;margin:10px;text-align:justify;">' . $sn . ' : ' . $qns . '</div></div></b>';
                    }
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by LMNTRIX, E & B Academy, Nagpur<br><br></span></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">About E & B Academy</a></div>
</div>
</body>
</html>
